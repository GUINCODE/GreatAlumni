<div class="container">
    ...
    <footer class=" mt-4">
        <nav class="navbar navbar-expand-lg text-light rounded">
            <a class="navbar-brand text-light" href="#">GreatAlumni</a>
            <button class="navbar-toggler  text-light" type="button" data-toggle="collapse" data-target="#navbarColor01"
            ...
            <div class="collapse navbar-collapse  text-light" id="navbarColor01">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  text-light" href="/GreatAlumni/vue/v_messagerie.php">Messagerie</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="btn btn-outline-danger btn-sm rounded "
                                href="/GreatAlumni/index.php">Deconnexion</a>
                        </li>
                    </ul>
                </div>
